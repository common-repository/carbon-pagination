 ...
 */
class CarbonPaginationItemFirstPageGetDirectionHtmlTest extends WP_UnitTestCase {

	public function setUp() {
		$mock_methods = array( 'get_first_html' );
	...
	/**
	 * @covers Carbon_Pagination_Item_First_Page::get_direction_html
	 */
