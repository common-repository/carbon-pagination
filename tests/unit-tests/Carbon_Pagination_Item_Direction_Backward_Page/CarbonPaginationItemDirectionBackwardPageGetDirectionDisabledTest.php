 ...
 */
class CarbonPaginationItemDirectionBackwardPageGetDirectionDisabledTest extends WP_UnitTestCase {
	...
	public function setUp() {
		...
		$this->item = $this->getMockForAbstractClass( 'Carbon_Pagination_Item_Direction_Backward_Page', $args );
	}
	...
	/**
	 * @covers Carbon_Pagination_Item_Direction_Backward_Page::get_direction_disabled
	 */
	 ...
	 * @covers Carbon_Pagination_Item_Direction_Backward_Page::get_direction_disabled
	 */
	public function testOnNonFirstPage() {
		$this->pagination->expects( $this->any() )
			->method( 'get_current_page' )
